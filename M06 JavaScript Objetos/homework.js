...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var Datos = { nombre: nombre  , edad: edad , meow: function(){
      return "Meow!"
   }}
   return Datos
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var otrosDatos = { nombre: nombre, email: email, password: password};
   return otrosDatos
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var Juandf = objetoMisterioso.numeroMisterioso * 5
   return Juandf
}
